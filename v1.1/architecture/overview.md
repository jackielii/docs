...
For readers primarily interested in what differentiates CockroachDB from other databases, we recommend focusing your energy on the [Transaction Layer](transaction-layer.html), though the [Replication Layer](replication-layer.html) is likely to be interesting, as well.
